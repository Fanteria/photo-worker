...
PictureData::PictureData(
    ...
    const unsigned int out_width_,
    const unsigned int out_height_,
    const unsigned int top_margin_,
    const unsigned int left_margin_,
    const unsigned int raw_width_,
    const unsigned int raw_height_) noexcept
    : width(width_),
      height(height_),
      ...
      raw_width(raw_width_),
      raw_height(raw_height_) {}
...
ostream &operator<<(ostream &os, const PictureData &pic) noexcept {
  os << "Image size:\t" << pic.width << " x " << pic.height
     << "\t\tWithout frame\n";
